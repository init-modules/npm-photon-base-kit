...
var createMarketingDemoVariantMap = (variant) => ({
  ...Object.fromEntries(
...
var defaultMarketingDemoVariantTheme = {
  ...
  heroSurface: "min-w-0 rounded-[40px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.14),transparent_28%),radial-gradient(circle_at_82%_12%,rgba(56,189,248,0.1),transparent_22%),linear-gradient(135deg,#07111f_0%,#09182d_44%,#10213a_100%)] text-white shadow-[0_34px_96px_rgba(2,12,27,0.34)]",
  panel: "min-w-0 rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]",
  mediaFrame: "min-w-0 overflow-hidden rounded-[32px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.08),transparent_54%),linear-gradient(180deg,rgba(9,18,31,0.94),rgba(6,12,22,0.99))]",
  heroOverlay: "bg-[linear-gradient(120deg,transparent,rgba(255,255,255,0.04),transparent)]",
  ...
  title: "block text-balance text-3xl font-semibold leading-[1.02] tracking-[-0.05em] text-white sm:text-4xl xl:text-5xl",
  ...
  primaryButton: "inline-flex items-center justify-center rounded-full border border-cyan-300/20 bg-cyan-300/15 px-5 py-3 text-sm font-semibold text-white backdrop-blur",
  secondaryButton: "inline-flex items-center justify-center rounded-full border border-white/10 px-5 py-3 text-sm font-semibold text-white/80",
  numberBadge: "mb-6 flex h-11 w-11 items-center justify-center rounded-2xl border border-cyan-300/18 bg-cyan-300/10 text-lg font-semibold text-cyan-100",
