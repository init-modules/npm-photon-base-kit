# @init-modules/website-builder-base-kit

Base installable kit for the package-first website builder.

## Назначение

@init-modules/website-builder-base-kit — npm/TypeScript package; Website Builder integration or runtime layer. Пакет экспортирует TypeScript/React primitives для frontend-части Init/Rx и не должен смешивать backend-интеграции с клиентским runtime.
...
~~~bash
npm install @init-modules/website-builder-base-kit
~~~
